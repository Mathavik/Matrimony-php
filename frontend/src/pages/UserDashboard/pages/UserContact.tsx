...
export default function UserContact() {
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      {/* ===== HERO SECTION ===== */}
      <div className="relative overflow-hidden min-h-[60vh] flex flex-col items-center text-center px-4 sm:px-6 md:px-10">        <div className="absolute inset-0">
        <img
        ...
        <div className="relative z-10 text-white pt-20 pb-12">
      ...
      {/* ===== CONTACT SECTION ===== */}
      <section className="max-w-7xl mx-auto px-4 sm:px-8 py-10 md:py-14 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">{/* LEFT DETAILS */}
        <div className="space-y-5 sm:space-y-6 text-left">
          ...
          {/* ADDRESS BLOCK */}
          <div className="space-y-2">   {/* gap reduce panniten */}
            ...
            {/* ADDRESS LINES — now starts IMMEDIATELY, no gap */}
            <div className="ml-8 text-sm sm:text-base text-gray-600 leading-relaxed space-y-1">
              <p>Corporate Office, Royal Deligt Matrimony</p>
              <p>4nd Floor, Square Building, Metro Train,</p>
              <p>MG Road, Tamil Nadu, India - 682016</p>
            </div>

          </div>


          <div className="space-y-4 text-sm sm:text-base mt-2">
